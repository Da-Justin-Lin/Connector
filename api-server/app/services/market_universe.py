...
UNIVERSE: list[tuple[str, str, str, float]] = [
    ...
    ("MU", "Micron Technology", "Technology", 1110),
    ("WDC", "Western Digital", "Technology", 265),
    ("SNDK", "SanDisk", "Technology", 146),
    ("LITE", "Lumentum Holdings", "Technology", 76),
    ("AAOI", "Applied Optoelectronics", "Technology", 44),
    ("COHR", "Coherent Corp", "Technology", 149),
    ("CIEN", "Ciena", "Technology", 118),
    ("GLW", "Corning", "Technology", 840),
